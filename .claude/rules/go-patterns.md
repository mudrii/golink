...
- Do not hardcode environment-specific values, collaborator selection, or operational limits, except for protocol-defined constants and explicit contract fixtures
...
- **Linting**: if the repo has a `.golangci` config, treat it as authoritative. Do not modify it without request. Fix all lint findings.
